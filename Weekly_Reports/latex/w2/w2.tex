...
\begin{document}
	...
	\begin{enumerate}[leftmargin=*]
		\item Implement and evaluate a classical computer vision feature extractor (e.g., HOG or color histogram) for object appearance matching in the MOT pipeline
	\end{enumerate}
